    ...
    <section className="bg-black from-blue-500 to-purple-600 text-white min-h-screen flex items-center justify-center">
      <div className="h-[50rem] w-full dark:bg-black bg-white dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
        ...
        <div className="relative z-20 text-center max-w-5xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold mx-auto text-center mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
          ...
          <button className="px-12 py-4 rounded-full bg-white font-bold text-black tracking-widest uppercase transform hover:scale-105 hover:bg-[#21e065] transition-colors duration-200">
            Start Free Trial
          </button>
          <p className="text-lg font-semibold sm:text-xl text-neutral-400 mt-5">
