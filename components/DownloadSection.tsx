...
export default function DownloadSection() {
  ...
  return (
    <section className="bg-black py-12">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start bg-black mt-4">
        <div className="flex flex-col items-start md:w-1/3 mb-6 md:mb-0 mt-10">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-6xl font-semibold text-left mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
        ...
        {/* <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
            <div className="relative z-10">
              <Lens hovering={hovering} setHovering={setHovering}>
                <Image
                  src="https://kitpapa.net/softzap/wp-content/uploads/2024/04/Software-Available-BG-5.webp"
                  alt="image"
                  width={500}
                  height={500}
